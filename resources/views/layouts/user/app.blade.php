            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    <h6 class="navbar-heading p-0 text-muted mt-2 mt-md-0 mb-1">
                        <span class="docs-normal">{{ auth()->user()->full_name }}</span>
                    </h6>
                    <!-- Nav items -->
                    <ul class="navbar-nav mt-1 mt-md-0">
                        <li class="nav-item">
                            <a class="nav-link @if (Route::is('user.gasoline_stations.*')) active @endif"
                                href="{{ route('user.gasoline_stations.index') }}">
                                <i class="fas fa-gas-pump"></i>
                                <span class="nav-link-text">Gasoline Stations</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if (Route::is('user.pages.about')) active @endif"
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if (Route::is('user.pages.privacy_policy')) active @endif"
                                href="{{ route('user.pages.privacy_policy') }}">
