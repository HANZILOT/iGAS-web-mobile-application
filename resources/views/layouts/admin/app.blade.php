        ...
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header d-flex align-items-center">
                <img class="navbar-brand mt-3" src="{{ handleNullAvatar(auth()->user()->avatar_profile) }}" width="115"
                    alt="avatar" title="{{ auth()->user()->full_name }}">
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav mt-1 mt-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if (Route::is('admin.gasoline_stations.*') ||
                                    Route::is('admin.gasoline_fees.*') ||
                                    Route::is('admin.services.*') ||
                                    Route::is('admin.staffs.*')) active @endif"
                                href="#to_gasoline_station_management" data-toggle="collapse" role="button"
                                aria-expanded="false" aria-controls="navbar-tables">
                                <i class="fas fa-gas-pump"></i>
                                <span class="nav-link-text">
                                    Gasoline Station Management
                                </span>
                            </a>
                            <div class="collapse @if (Route::is('admin.gasoline_stations.*') ||
                                    Route::is('admin.gasoline_fees.*') ||
                                    Route::is('admin.services.*') ||
                                    Route::is('admin.staffs.*')) show @endif"
                                id="to_gasoline_station_management">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.gasoline_stations.index') }}"
                                            class="nav-link @if (Route::is('admin.gasoline_stations.*')) text-primary @endif">
                                            Gasoline Stations
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('admin.gasoline_fees.index') }}"
                                            class="nav-link  @if (Route::is('admin.gasoline_fees.*')) text-primary @endif">
                                            Gasoline Prices
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('admin.staffs.index') }}"
                                            class="nav-link  @if (Route::is('admin.staffs.*')) text-primary @endif">
                                            Staffs
                                        </a>
                                    </li>
                                </ul>
