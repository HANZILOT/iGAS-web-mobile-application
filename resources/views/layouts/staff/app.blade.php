            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav mt-1 mt-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if (Route::is('staff.gasoline_stations.*')) active @endif"
                                href="{{ route('staff.gasoline_stations.index') }}">
                                <i class="fas fa-gas-pump"></i>
                                <span class="nav-link-text">Gasoline Station</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if (Route::is('staff.gasoline_fees.*')) active @endif"
                                href="{{ route('staff.gasoline_fees.index') }}">
                                <i class="fas fa-credit-card"></i>
                                <span class="nav-link-text">Gasoline Prices</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if (Route::is('staff.services.*')) active @endif"
