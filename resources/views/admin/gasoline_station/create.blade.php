...
@section('title', 'Admin | Create Gasoline Station')
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <form class="row" action="{{ route('admin.gasoline_stations.store') }}" method="post"
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div id="map" style="margin-bottom: 20px;"></div>
                                         <div class="coordinates-container">
                                            <div class="input-field-wrapper">
                                                ...
                                                <input type="text" id="latitude" name="latitude" class="input-field">
                                            </div>
                                            <div class="input-field-wrapper">
                                                <label for="longitude" class="input-label">Longitude</label>
                                                <input type="text" id="longitude" name="longitude" class="input-field">
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-none" id="timeInputs">
                                            <div class="form-group mb-2">
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="btn btn-primary"
                                                onclick="promptStore(event, '#gasoline_station_form')">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
