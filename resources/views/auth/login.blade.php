    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7 px-5 mt-6">
                <img class="img-fluid d-block mx-auto" src="{{ asset('img/auth/gas_station.svg') }}" alt="logo">
                <br>
                {{-- Form --}}
                <form action="{{ route('auth.attemptLogin') }}" method="post">
                    ...
                    <h3 class="text-center text-white font-weight-bold">Welcome to iGAS!</h3>
                    <h5 class="text-center text-white font-weight-bold">Gas Station and Fuel Finder <i
                            class="fas fa-map-marker-alt ml-1 text-danger"></i></h5> <br>
